...
// Input Schema for the GetDeployment tool
const getDeploymentInputSchema = `{
  "properties": {
    "deployment_id": {
...
// Response Template for the GetDeployment tool (Status: 200, Content-Type: application/json)
const GetDeploymentResponseTemplate_A = `# API Response Information
...
// Response Template for the GetDeployment tool (Status: 400, Content-Type: application/json)
const GetDeploymentResponseTemplate_B = `# API Response Information
...
// Response Template for the GetDeployment tool (Status: 401, Content-Type: application/json)
const GetDeploymentResponseTemplate_C = `# API Response Information
...
// Response Template for the GetDeployment tool (Status: 403, Content-Type: application/json)
const GetDeploymentResponseTemplate_D = `# API Response Information
...
// Response Template for the GetDeployment tool (Status: 404, Content-Type: application/json)
const GetDeploymentResponseTemplate_E = `# API Response Information
...
// Response Template for the GetDeployment tool (Status: 422, Content-Type: application/json)
const GetDeploymentResponseTemplate_F = `# API Response Information
...
// Response Template for the GetDeployment tool (Status: 500, Content-Type: application/json)
const GetDeploymentResponseTemplate_G = `# API Response Information
...
// NewGetDeploymentMCPTool creates the MCP Tool instance for GetDeployment
func NewGetDeploymentMCPTool() mcp.Tool {
	return mcp.NewToolWithRawSchema(
		"GetDeployment",
		"Get deployment - Retrieves detailed information about a specific deployment",
		[]byte(getDeploymentInputSchema),
	)
}

// GetDeploymentHandler is the handler function for the GetDeployment tool.
...
func GetDeploymentHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	return nil, fmt.Errorf("%s not implemented", "GetDeployment")
}
