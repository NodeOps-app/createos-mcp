...
func NewMCPServer() *server.MCPServer {
	...
	s.AddTool(mcptools.NewAttachSandboxDiskMCPTool(), handler.AttachSandboxDiskHandler)
	s.AddTool(mcptools.NewAttachSandboxNetworkMCPTool(), handler.AttachSandboxNetworkHandler)
	...
	s.AddTool(mcptools.NewCreateDiskMCPTool(), handler.CreateDiskHandler)
	s.AddTool(mcptools.NewCreateDomainMCPTool(), handler.CreateDomainHandler)
	s.AddTool(mcptools.NewCreateNetworkMCPTool(), handler.CreateNetworkHandler)
	...
	s.AddTool(mcptools.NewCreateSandboxMCPTool(), handler.CreateSandboxHandler)
	...
	s.AddTool(mcptools.NewDeleteDiskMCPTool(), handler.DeleteDiskHandler)
	s.AddTool(mcptools.NewDeleteDomainMCPTool(), handler.DeleteDomainHandler)
	s.AddTool(mcptools.NewDeleteNetworkMCPTool(), handler.DeleteNetworkHandler)
	...
	s.AddTool(mcptools.NewDeleteSandboxMCPTool(), handler.DeleteSandboxHandler)
	s.AddTool(mcptools.NewDetachSandboxDiskMCPTool(), handler.DetachSandboxDiskHandler)
	s.AddTool(mcptools.NewDetachSandboxNetworkMCPTool(), handler.DetachSandboxNetworkHandler)
	...
	s.AddTool(mcptools.NewExecSandboxMCPTool(), handler.ExecSandboxHandler)
	...
	s.AddTool(mcptools.NewGetDiskMCPTool(), handler.GetDiskHandler)
	s.AddTool(mcptools.NewGetGithubRepositoryContentMCPTool(), handler.GetGithubRepositoryContentHandler)
	s.AddTool(mcptools.NewGetNetworkMCPTool(), handler.GetNetworkHandler)
	...
	s.AddTool(mcptools.NewGetSandboxMCPTool(), handler.GetSandboxHandler)
	...
	s.AddTool(mcptools.NewListDisksMCPTool(), handler.ListDisksHandler)
	...
	s.AddTool(mcptools.NewListNetworksMCPTool(), handler.ListNetworksHandler)
	...
	s.AddTool(mcptools.NewListSandboxDisksMCPTool(), handler.ListSandboxDisksHandler)
	s.AddTool(mcptools.NewListSandboxesMCPTool(), handler.ListSandboxesHandler)
	...
	s.AddTool(mcptools.NewUpdateSandboxMCPTool(), handler.UpdateSandboxHandler)
