...
type ListMyProjectTemplatesParams struct {
...
func ListMyProjectTemplatesHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	params, err := mcputils.ParamsParser[ListMyProjectTemplatesParams](args)
	if err != nil {
	...
	return makeGetRequest("/v1/project-templates/my", queryParams, authInfo)
}
