...
type GetProjectEnvironmentAnalyticsParams struct {
...
func GetProjectEnvironmentAnalyticsHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	params, err := mcputils.ParamsParser[GetProjectEnvironmentAnalyticsParams](args)
	if err != nil {
		return nil, err
	}
	...
	return makeGetRequest(fmt.Sprintf("/v1/projects/%s/environments/%s/analytics", params.ProjectID, params.EnvironmentID), queryParams, authInfo)
}
